...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "...", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "...", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("7", "...", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("8", "...", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("9", "...", Model_Menu.MenuType.MENU));
