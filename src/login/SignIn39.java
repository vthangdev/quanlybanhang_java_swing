...
import login.component.Message;
import login.component.PanelCover;
import login.component.PanelLoading;
import login.component.PanelLoginAndRegister;
import login.component.PanelVerifyCode;
import login.connection.JDBCConnection;
import login.model.ModelLogin;
import login.model.ModelMessage;
import login.model.ModelUser;
import login.service.ServiceMail;
import login.service.ServiceUser;
...
public class SignIn39 extends javax.swing.JFrame {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    if (service.verifyCodeWithUser(user.getUserID(), verifyCode.getInputCode())) {
                        ...
                        showMessage(Message.MessageType.ERROR, "Verify code không chính xác");
                    }
                } catch (SQLException e) {
                    showMessage(Message.MessageType.ERROR, "Lỗi");
                }
            }
        });
    }
    ...
    private void register() {
        ...
        try {
            ...
            showMessage(Message.MessageType.ERROR, "Đăng ký không thành công");
        }
    }
    ...
    private void login() {
        ...
        try {
            ...
            if (user != null) {
                ...
                showMessage(Message.MessageType.ERROR, "Email và Password không chính xác");
            }

        } catch (SQLException e) {
            showMessage(Message.MessageType.ERROR, "Đăng nhập lỗi");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignIn39.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        try {
            JDBCConnection.getInstance().connectToDatabase();
        } catch (SQLException e) {
            e.printStackTrace();
        }
